...
/* harmony import */ var _global_axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../global/axios */ "./resources/js/global/axios.js");
/* harmony import */ var _controls_InputGroup_InputGroup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../controls/InputGroup/InputGroup */ "./resources/js/components/ui/controls/InputGroup/InputGroup.js");
/* harmony import */ var _rules__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../rules */ "./resources/js/components/ui/forms/rules.js");
/* harmony import */ var _store_actions_AuthActionCreator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../store/actions/AuthActionCreator */ "./resources/js/store/actions/AuthActionCreator.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Component) {
  ...
  function RegisterForm() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleErrors", function (field) {
      ...
      if (!!field.rules[_rules__WEBPACK_IMPORTED_MODULE_4__["rules"].required]) {
        if (field.value.length == 0) field.errors.push("This field is required! ");
      } //email


      if (!!field.rules[_rules__WEBPACK_IMPORTED_MODULE_4__["rules"].email]) {
        var re = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
        if (!re.test(field.value.toLowerCase())) field.errors.push("Wrong email address! ");
      } //min


      if (!!field.rules[_rules__WEBPACK_IMPORTED_MODULE_4__["rules"].min]) {
        var rule = field.rules[_rules__WEBPACK_IMPORTED_MODULE_4__["rules"].min];
    ...
    _defineProperty(_assertThisInitialized(_this), "checkIsBusy", function (e) {
      ...
      _global_axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('isbusy', {
        email: field.value
      }).then(function (data) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderInputs", function () {
      return Object.keys(_this.state.controls).map(function (key, index) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_controls_InputGroup_InputGroup__WEBPACK_IMPORTED_MODULE_3__["default"], {
          key: key + index,
          type: control.type,
          label: control.label,
          field: control.field,
...
function mapDispatchtoProps(dispatch) {
  return {
    login: function login(email, password) {
      return dispatch(_store_actions_AuthActionCreator__WEBPACK_IMPORTED_MODULE_5__["AuthActionCreator"].login(email, password));
    }
  };
}

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(null, mapDispatchtoProps)(RegisterForm));
